        ...
        <div class=" container">
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-10">
                    <!-- <div class="testimonial__slider-3" style="background-color: bisque;">
                        <h3 class="testimonial__title" style="text-align: center; color: black;">
                            {{ tourData?.dayInTour }}<br>
                        </h3>
                        <h3 class="testimonial__title" style="text-align: center;color: black;">
                            {{ tourData?.tourName }}</h3>
                        <h5 class="testimonial__info-2" style="text-align: center;color: black;">
                            {{ tourData?.tourSmallInformation }}</h5>
                        <hr>
                        <hr>
                        <div class="testimonial__slider-wrapper swiper-container testimonial-text mb-35">
                            <swiper ref="mySwiper" :modules="modules" :loop="true" :autoplay="{ delay: 5000 }"
                                ...
                                <swiper-slide v-for="item in sliderData" :key="item?.length">
                                    <div class="testimonial__item-3">
                                        <ul>
                                            <li v-for="info in item" :key="info">
