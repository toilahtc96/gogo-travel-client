...
import { ref } from 'vue';
const imageSrc = (imgSrc: string) => {
    return new URL(imgSrc, import.meta.url).href;
}
const blogData = ref([
    {
        id: 1,
        blogImg: imageSrc(`../../../../assets/img/blog/blog-1.jpg`),
        title: 'The Challenge Of Global Learning In Public Education',
        author: imageSrc(`../../../../assets/img/blog/author/author-1.jpg`),
    ...
    {
        id: 2,
        blogImg: imageSrc(`../../../../assets/img/blog/blog-2.jpg`),
        title: 'Exactly How Technology Can Make Reading Better',
        author: imageSrc(`../../../../assets/img/blog/author/author-2.jpg`),
    ...
    {
        id: 3,
        blogImg: imageSrc(`../../../../assets/img/blog/blog-3.jpg`),
        title: 'New Chicago school budget relies on state pension',
        author: imageSrc(`../../../../assets/img/blog/author/author-3.jpg`),
        authorName: 'Jim Séchen',
        date: 'March 05, 2022',
        category: 'UX Design',
        color: 'pink'
